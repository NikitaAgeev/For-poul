...
void Vtb_std__03a__03aprocess__Vclpkg::__VnoInFunc_killQueue(Vtb__Syms* __restrict vlSymsp, VlQueue<VlClassRef<Vtb_std__03a__03aprocess>> &processQueue) {
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vtb_std__03a__03aprocess__Vclpkg::__VnoInFunc_killQueue\n"); );
    // Body
